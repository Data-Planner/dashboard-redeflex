...
export const Route = createFileRoute("/metas")({
  head: () => ({
    meta: [
      { title: "Metas — Painel Interno" },
      { name: "description", content: "Quadro de metas do quadrimestre." },
    ],
  }),
  component: MetasPage,
});
...
const QUALITIES: Record<Quality, { label: string; resolution: string; file: string; sizeHint: string }> = {
  hd: { label: "HD", resolution: "1280 × 720", file: "/metas_hd.png", sizeHint: "Ideal p/ e-mail" },
  fhd: { label: "Full HD", resolution: "1920 × 1080", file: "/metas_fhd.png", sizeHint: "Recomendado" },
  "4k": { label: "4K Ultra HD", resolution: "3840 × 2160", file: "/metas_4k.png", sizeHint: "Máxima nitidez" },
};
...
const METAS_DATA = [
  { n: 1, meta: "Atingir meta de gastos estabelecida para área no 1º Q26", detalhe: "Realizado de despesas menor que o orçamento planejamento para o quadrimestre." },
  { n: 2, meta: "Reestruturar o Painel de Gestão do Comercial e MKT (Intraflex)", detalhe: "Sanear / Organizar / Simplificar o painel do Intraflex Comercial + MKT" },
  { n: 3, meta: "Garantir o rollout do One Page + Plan Único para todos os DDDs.", detalhe: "Implementar em todos os DDDs os dois relatórios." },
  { n: 4, meta: "RV 2026", detalhe: "Apoiar e implementar o novo modelo de metas do time comercial para 2026. Garantir o acompanhamento semanal do alcance de metas do time comercial, de acordo com o novo modelo de RV 2026." },
  { n: 5, meta: "Atingir a Receita de Ativação prevista para o Quadrimestre", detalhe: "Garantir o acompanhamento das ativações mensalmente, atuando na redução da dispersão entre o que foi ativado e o que realmente foi pago." },
  { n: 6, meta: "Monitor de performance - Adquirência", detalhe: "Relatório publicado no Intraflex" },
];
...
function MetasPage() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `Metas_16x9_${current.label}_${todayStamp()}.png`;
    ...
    <div className="min-h-screen bg-[#f3f4f6] flex flex-col items-center">
      ...
      >
        ...
        <div className="bg-[#A01310] h-16 flex items-center px-12 justify-between shrink-0">
          ...
          <div className="text-white/80 text-sm font-medium">1º Quadrimestre 2026</div>
        </div>
